# 6.3 Barplot in R Markdown {.unnumbered}

### Video: Barplot in R Markdown
...
{{< video https://www.youtube.com/watch?v=dE00hzvmOAI >}}
...
## 6.3.1 Preparing directory and data setup
...
## 6.3.2 Add one legend for multiple graphs
...
VRI Data CSV: [VRI_data.csv](/external_files/VRI_data-1.csv)

VRI RData: [VRI_data.RData](/external_files/VRI_data-3.RData)

Trees text file: [trees.txt](/external_files/trees-1.txt)

Trees RData: [trees.RData](/external_files/trees.RData)
:::
