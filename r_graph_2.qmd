# 6.1 Basic Graphs: RStudio and R Markdown {.unnumbered}
...
{{< video https://www.youtube.com/watch?v=fbRdZDYGi4s >}}
...
VRI Data csv: [VRI data.csv](/external_files/VRI_data-4.csv)

VRI Data RData: [VRI data.RData](/external_files/VRI_data.RData)
:::